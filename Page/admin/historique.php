...
<body>
  ...
  <div class="container">
    ...
    if (isset($_GET['id'])) {
      ...
      $historie[] = historique($_GET['id']);
      if ($historie) {
        foreach ($historie as $histo) {
          if (!empty($histo)) {
            echo "<h2 class='text-center text-uppercase'>{$histo[0]['nomClient']}- Historique</h2>";
            ...
            echo "<p class='text-center'>Aucun historique trouvé pour cette Client.</p>";
          }
        }
      }
    }
